...
```
有了代理实例对象，我们就可以利用它进行操作了，[演示结果](./picture/java7-代理-2.gif)，[完整流程图](./picture/java7-代理-3.png)
...
```
[测试结果](./picture/java7-代理-6.gif)
[此时各组件之间关系、调用情况](./picture/java7-代理-7.png)
...
[追下源码，看看JDK的动态代理是否与我们的手动实现是否一致](./picture/java7-代理-8.gif)
